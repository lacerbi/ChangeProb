function [marginalLikelihood, modelPost, nLL, rmse, fitParams, resp_model,...
    resp_obs, p_true, p_estimate, post] = changeprob_mL(model, data, task, parameters, gridSize, paramBounds)
...
%% CHANGEPROB_ML Computes marginal likelihood for the specified model
    ...
    switch NumParams
        ...
        case 3
            ...
            post = post{I_firstParam, I_secondParam, I_thirdParam};
        case 4
            % Add the log likelihood to the log prior, subtract the max, and
            % exponentiate
            ...
            post = post{I_firstParam, I_secondParam, I_thirdParam, I_fourthParam};
        case 5
            % Add the log likelihood to the log prior, subtract the max, and
            % exponentiate
            ...
            post = post{I_firstParam, I_secondParam, I_thirdParam, I_fourthParam, I_fifthParam};
        otherwise
